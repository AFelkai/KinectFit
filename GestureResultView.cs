...
namespace KinectFit
{
    ...
    public sealed class GestureResultView : INotifyPropertyChanged
    {
        ...
        private readonly ImageSource pushUpImage = new BitmapImage(new Uri(@"Images\PushUp.png", UriKind.Relative));

        /// <summary> Image to show when the 'detected' property is false for a tracked body </summary>
        private readonly ImageSource notPushUpImage = new BitmapImage(new Uri(@"Images\NotPushUp.png", UriKind.Relative));
        ...
        public void UpdateGestureResult(bool isBodyTrackingIdValid, bool isGestureDetected, float detectionConfidence)
        {
            ...
            else
            {
                ...
                if (this.Detected)
                {
                    ...
                    this.ImageSource = this.pushUpImage;
                }
                else
                {
                    this.ImageSource = this.notPushUpImage;
                }
            }
        }
